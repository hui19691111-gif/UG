...
//
//       Filename:  G:\UG智辉钣金插件_源码精简_20260605_最终精简\features\03_ZiDonFenCen\ZiDonFenCen.hpp
//
...
private:
    ...
    NXOpen::BlockStyler::Toggle* toggleBatchBodyQuantity;// Block type: Toggle
    NXOpen::BlockStyler::Toggle* toggleBatchLayerFilter;// Block type: Toggle
    NXOpen::BlockStyler::IntegerBlock* integerBatchLayerStart;// Block type: Integer
    NXOpen::BlockStyler::IntegerBlock* integerBatchLayerEnd;// Block type: Integer
    NXOpen::BlockStyler::Toggle* toggleBatchSizeFilter;// Block type: Toggle
    NXOpen::BlockStyler::DoubleBlock* doubleBatchMinWidth;// Block type: Double
    NXOpen::BlockStyler::DoubleBlock* doubleBatchMinLength;// Block type: Double
    NXOpen::BlockStyler::Toggle* toggleBatchFastenerFilter;// Block type: Toggle
    NXOpen::BlockStyler::SelectObject* selection0;// Block type: Selection
    NXOpen::BlockStyler::SelectObject* selectionBatchComponents;// Block type: Selection
    ...
    NXOpen::BlockStyler::Toggle* toggleSetBodyName;// Block type: Toggle
    NXOpen::BlockStyler::StringBlock* stringBodyName;// Block type: String
