...
private:
    ...
    NXOpen::BlockStyler::SelectObject* selectionEdge0;// Block type: Selection
    NXOpen::BlockStyler::Group* group;// Block type: Group
    NXOpen::BlockStyler::Toggle* togglebaobian;// Block type: Toggle
    ...
    NXOpen::BlockStyler::DoubleBlock* reliefDepthDouble;// Block type: Double
    NXOpen::BlockStyler::DoubleBlock* reliefWidthDouble;// Block type: Double
    NXOpen::BlockStyler::DoubleBlock* innerRadiusDouble;// Block type: Double
    NXOpen::BlockStyler::Button* settingsButton;// Block type: Button

    void baobian();
    void ask_expression(const char* expName);
};
