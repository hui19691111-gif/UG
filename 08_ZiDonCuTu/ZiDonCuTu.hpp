...
//
//       Filename:  G:\UG智辉钣金插件_源码精简_20260605_最终精简\features\08_ZiDonCuTu\ZiDonCuTu.hpp
//
...
private:
    ...
    NXOpen::BlockStyler::Group* groupHoleSwitchRow;// Block type: Group
    ...
    NXOpen::BlockStyler::Group* groupHoleSwitchRow1;// Block type: Group
    ...
    NXOpen::BlockStyler::Group* groupHoleSwitchRow12;// Block type: Group
    NXOpen::BlockStyler::Toggle* toggleBendNote1;// Block type: Toggle
    NXOpen::BlockStyler::DoubleBlock* doubleBendNoteTextHeight1;// Block type: Double
    NXOpen::BlockStyler::Group* groupHoleSwitchRow13;// Block type: Group
    NXOpen::BlockStyler::Toggle* toggleBendNote2;// Block type: Toggle
    NXOpen::BlockStyler::DoubleBlock* doubleBendNoteTextHeight2;// Block type: Double
    NXOpen::BlockStyler::Group* groupHoleSwitchRow11;// Block type: Group
    NXOpen::BlockStyler::Toggle* toggleBreakBendLine1;// Block type: Toggle
